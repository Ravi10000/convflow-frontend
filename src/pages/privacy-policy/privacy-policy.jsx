function PrivacyPolicyPage() {
  return (
    <div className="_section_container">
      <seciton className="_section _center">
      ...
      <seciton className="_section">
        ...
        <ul>
          ...
          <li>
            ...
            this Agreement) refers to QwertyAbcd Labs, H No.147/9,147/10,Plot
            No.100, Indira Housing society, Nagpur, MH.
          </li>
          <li>
          ...
          <li>
            Website refers to ConvFlow, accessible from{' '}
            <a href="www.convflow.com">www.convflow.com</a>
          </li>
          <li>
      ...
      <section className="_section">
        ...
        <ul>
          <li>
            <h5>Cookies or Browser Cookies.</h5> A cookie is a small file placed
          ...
          <li>
            <h5>Web Beacons.</h5> Certain sections of our Service and our emails
      ...
      <section className="_section">
        ...
        <ul>
          ...
          <li>
            <span className="_semibold">To manage Your Account:</span> to manage
          ...
          <li>
            <span className="_semibold">To contact You:</span> To contact You by
          ...
          <li>
            <span className="_semibold">To provide You</span>
          ...
          <li>
            <span className="_semibold">To manage Your requests:</span>
            To attend and manage Your requests to Us.
          </li>
          <li>
            <span className="_semibold">For business transfers:</span>
          ...
          <li>
            <span className="_semibold">For other purposes:</span>
        ...
        <ul>
          <li>
            <span className="_semibold">With Service Providers:</span> We may
            share Your personal information with Service Providers to monitor
            and analyze the use of our Service, to contact You.
          </li>
          <li>
            <span className="_semibold">For business transfers:</span> We may
          ...
          <li>
            <span className="_semibold">With Affiliates:</span> We may share
          ...
          <li>
            <span className="_semibold">With other users:</span> when You share
          ...
          <li>
            <span className="_semibold">With Your consent:</span> We may
      ...
      <section className="_section">
        ...
        <ul>
          <li>By phone number: 8002985878</li>
        </ul>
      </section>
    </div>
  );
