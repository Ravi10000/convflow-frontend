function TermsPage() {
  return (
    <div className="_section_container">
      <section className="_section _center">
      ...
      <section className="_section">
        ...
        <p>
          ...
          <br /> The following definitions shall have the same meaning
      ...
      <section className="_section">
        ...
        <ul>
          ...
          <li>
            ...
            agreement has been created with the help of the Free Terms and
          ...
          <li>Website refers to ConvFlow, accessible from www.convflow.com</li>
          <li>
